...
// Source: github.com/bradfordwagner/go-util (interfaces: StubOneOf,StubConversionOneOf)
...
func (mr *MockStubOneOfMockRecorder) Invoke(arg0 interface{}) *gomock.Call {
...
// Invoke mocks base method.
func (m *MockStubConversionOneOf) Invoke(arg0 interface{}) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Invoke", arg0)
}

// Invoke indicates an expected call of Invoke.
func (mr *MockStubConversionOneOfMockRecorder) Invoke(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
